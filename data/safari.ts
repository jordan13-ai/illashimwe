...
export const SAFARI_PACKAGES: SafariPackage[] = [
    ...
    {
        title: "8-Day Shared Safari & Zanzibar",
        slug: "group-safari-zanzibar",
        duration: "8 Days",
        image: "/images/group-of-zebras-standing-on-a-field-in-tanzania-2026-03-09-01-51-11-utc.webp",
        ...
        itinerary: [
            { day: "Day 1", title: "Arusha Arrival", description: "Meet the group and overnight in Arusha." },
            { day: "Day 2", title: "Tarangire National Park", description: "Shared game drive. Public campsite." },
            { day: "Day 3", title: "Serengeti National Park", description: "Drive to Serengeti. Game viewing." },
            { day: "Day 4", title: "Serengeti & Ngorongoro", description: "Morning drive. Move to crater rim." },
            { day: "Day 5", title: "Ngorongoro Crater", description: "Crater drive. Return to Arusha." },
        ...
        exclusions: ["International flights", "Visas", "Drinks", "Tips"],
        gallery: [
            "/images/group-of-zebras-standing-on-a-field-in-tanzania-2026-03-09-01-51-11-utc.webp",
            "/images/beautiful-tropical-beach-with-white-sand-and-clear-2026-03-18-05-44-03-utc.webp",
        ],
    ...
    {
        title: "6-Day Pure Zanzibar Bliss",
        slug: "pure-zanzibar-bliss",
        duration: "6 Days",
        image: "/images/beautiful-wooden-pier-with-thatched-huts-in-ocean-2026-03-25-00-02-46-utc.webp",
        description: "A complete immersion into the white sands, turquoise waters, and rich culture of Zanzibar.",
        price: "$1,200",
        categories: ["beach"],
        tag: "Relaxation",
        overview: `<p>Skip the mainland and head straight for paradise. This 6-day itinerary focuses entirely on the tropical bliss of Zanzibar Island. From the historic alleys of Stone Town to the pristine northern beaches, this is the ultimate tropical escape.</p>`,
        highlights: ["Stone Town Walking Tour", "Spice Farm Visit", "Sunset Dhow Cruise", "Luxury Beach Resort"],
        itinerary: [
            { day: "Day 1", title: "Stone Town Arrival", description: "Arrive in Zanzibar and transfer to a boutique hotel in historic Stone Town." },
            { day: "Day 2", title: "Spice Tour & Beach Transfer", description: "Morning spice farm tour, then transfer to your beachfront resort in Nungwi or Kendwa." },
            { day: "Day 3-4", title: "Tropical Relaxation", description: "Two full days at leisure. Optional snorkeling at Mnemba Atoll." },
            { day: "Day 5", title: "Sunset Dhow Cruise", description: "Relax at the resort, followed by a traditional sunset dhow sailing cruise." },
            { day: "Day 6", title: "Departure", description: "Transfer to Zanzibar International Airport for your flight home." }
        ],
        inclusions: ["Airport transfers", "Stone Town tour", "Spice tour", "Dhow cruise", "5-star beach resort accommodation (half board)"],
        exclusions: ["International flights", "Visas", "Lunch", "Drinks", "Tips"],
        gallery: [
